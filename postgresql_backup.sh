...
# Backup create
# PostgreSQL can be installed on the server via the package manager, you can use the pg_dump command. 'su - postgres -c "pg_dump -U postgres DB_NAME | gzip > /mount/dbfiles/$ARCHIVE'
